...
@pytest.fixture
def dictor_layout():
    from dict_finger import keyboard_finger_dictor, dictor_finger_count
    return keyboard_finger_dictor, dictor_finger_count

@pytest.fixture
def test_text():
    return "А Жинжикова не дура!"

def test_count_finger_load_dictor(dictor_layout, test_text):
    keyboard_layout, finger_count = dictor_layout
    
    result = count_finger_load_dictor(test_text)
